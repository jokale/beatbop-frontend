        ...
        return (
            <footer id="footer"> <center>
                ...
                <small style={{color: "#55025e", fontFamily: 'Abril Fatface'}}>
                    You can find the code repo on <a href="https://github.com/jokale/on-the-rag-frontend-final" target="_blank" rel="noopener noreferrer">Github</a>. Feel free to make any pull requests to improve the aplication.
                </small>
